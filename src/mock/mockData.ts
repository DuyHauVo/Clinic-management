...
// ============================================================
// 4. DANH MỤC 04/DM: THIẾT BỊ Y TẾ ÁP DỤNG THANH TOÁN BHYT (LOẠI 11 - GuiDanhMuc04_DMVTYT)
// ============================================================
export const initialThietBiData: DmThietBiItem[] = [
  {
    ...
    maVatTu: 'N04.01.001',
    nhomVatTu: 'Kim tiêm',
    tenVatTu: 'Kim dùng cho buồng tiêm 20G x 25mm',
    maHieu: 'MH-KT-2024',
    soLuuHanh: '2400012/ĐKLH/BYT',
    tinhnangKt: 'Thép không gỉ y tế 304, đầu vát Huber không lõi chống cắt silicone',
    quyCach: '1 bộ/túi (Hộp 50 túi)',
    hangSx: 'B. Braun Medical AG',
    nuocSx: 'Đức',
    donViTinh: 'Cái',
    donGia: 15000,
    donGiaBh: 15000,
    ...
    soLuong: 770,
    dinhMuc: 1,
    nhaThau: 'Công ty Cổ phần Dược phẩm & TBYT Trung Ương',
  ...
  },
  {
    ...
    stt: 2,
    maVatTu: 'N04.02.015',
    nhomVatTu: 'Dây truyền dịch',
    tenVatTu: 'Dây truyền dịch có màng lọc vô khuẩn kèm van an toàn',
    maHieu: 'IS-FILT-02',
    soLuuHanh: '2300054/ĐKLH/BYT',
    tinhnangKt: 'Màng lọc 15 micron, buồng đếm giọt 20 giọt/ml, dây PVC không DEHP',
    quyCach: '1 dây/túi (Thùng 100 dây)',
    hangSx: 'Terumo Corporation',
    nuocSx: 'Nhật Bản',
    donViTinh: 'Dây',
    donGia: 8500,
    donGiaBh: 8500,
    ...
    soLuong: 12000,
    dinhMuc: 1,
    nhaThau: 'Công ty TNHH Thiết bị Y tế Hoàng Long',
  ...
  },
  {
    ...
    stt: 3,
    maVatTu: 'N04.05.088',
    nhomVatTu: 'Dụng cụ khâu nối phẫu thuật',
    tenVatTu: 'Băng đạn dùng cho dụng cụ khâu cắt nội soi đa năng',
    maHieu: 'ENDO-STAP-60',
    soLuuHanh: '2200119/ĐKLH/BYT',
    tinhnangKt: 'Chiều dài đường khâu 60mm, 6 hàng ghim titan phủ kín',
    quyCach: '1 cái/hộp tiệt trùng',
    hangSx: 'Medtronic Covidien',
    nuocSx: 'Hoa Kỳ',
    donViTinh: 'Cái',
    donGia: 3250000,
    donGiaBh: 3250000,
    ...
    soLuong: 150,
    dinhMuc: 4,
    nhaThau: 'Công ty Cổ phần Đầu tư Y tế Việt Pháp',
