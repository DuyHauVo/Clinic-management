...
export const DICHVU_SCHEMA_FIELDS: DichVuSchemaField[] = [
  ...
  },
  {
    ...
    aliases: [
      ...
      "SOLUONGCGKT",
      "SỐ LƯỢNG CGKT",
      "SỐ LƯỢNG CHUYỂN GIAO KỸ THUẬT",
      "SO_LUONG_CHUYEN_GIAO",
      "SL_CGKT",
    ],
    example: "100",
  },
...
export const DICHVU_EXCEL_TEMPLATE_HEADERS = DICHVU_SCHEMA_FIELDS.map(
  (f) => f.key,
);
export const DICHVU_EXCEL_TEMPLATE_LABELS = DICHVU_SCHEMA_FIELDS.map(
  (f) => f.label,
);

export const DICHVU_EXCEL_TEMPLATE_COLS = [
  { wch: 6 }, // STT
  { wch: 16 }, // MA_DICH_VU
  { wch: 35 }, // TEN_DICH_VU
  { wch: 35 }, // TEN_DVKT_GIA
